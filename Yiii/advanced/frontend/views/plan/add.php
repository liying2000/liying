...
<div class="right">
    <div class="search-box">
        <form action="<?php echo Url::to(['plan/add_do'])?>" method="post">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                    <input class="filed_name" type="text" name="filed_name">
                </li>
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed_value" type="text" name="filed_value">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text"   name="filed_wood1" class="length"  placeholder="选项1">
                    <input type="text"   name="filed_wood2" class="length" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input  type="text"  placeholder="请输入最小长度" class="length" name="filed_min" >
                    ~
                    <input  type="text"  placeholder="请输入最大长度" class="length" name="filed_max" >
                </li>
                <li>
